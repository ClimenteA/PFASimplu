// ./deno run --allow-all factura.js

import { PDFDocument } from "./libs/pdf-lib.esm.js"
...
export async function creeaza_factura(dateFactura) {
    ...
    await Deno.writeFile(dateFactura.facturaPath, pdfBytes)

    return dateFactura.facturaPath
